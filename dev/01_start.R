...
golem::fill_desc(
  ...
  repo_url = "https://github.com/ngsanogo/corpoaccidentdash" # The URL of the GitHub Repo (optional) 
)     
...
usethis::use_mit_license( name = "N'Gouro dit Issa Sanogo" )  # You can set another license here
